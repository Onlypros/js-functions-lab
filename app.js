...
Complete the exercise in the space below:
*/
function isCharAVowel(isVowel){
    if (isVowel === 'a' ||isVowel === 'A' ||isVowel === 'e' ||isVowel === 'E' ||isVowel === 'i' ||
        isVowel === 'I' ||isVowel === 'o' ||isVowel === 'O' ||isVowel === 'u' ||isVowel === 'U' ) {
        return 'true';
    } else {
      return 'false';
    }
...
console.log('Exercise 4 Result:', generateEmail("bob", "gmail.com"));
...
console.log('Exercise 5 Result:', greetUser("mike", "evening"));
...
console.log('Exercise 6 Result:', maxOfThree(5, 7,9));
...
console.log('Exercise 11 Result:', createUsername("michael", "jordan"));
...
console.log('Exercise 12 Result:', numArgs(1,));
